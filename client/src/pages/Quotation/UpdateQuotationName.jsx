...
const UpdateQuotation = () => {
  ...
  useEffect(() => {
    const fetchQuotation = async () => {
      try {
        const response = await axios.get(`https://crm.dentalguru.software/api/quotation-name/${id}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.put(`https://crm.dentalguru.software/api/quotation-data/${id}`, editData);
